...
func (s *OpenAIGatewayService) ForwardAsChatCompletions(
	...
	var handleErr error
	if clientStream {
		result, handleErr = s.handleChatStreamingResponse(ctx, resp, c, account, originalModel, billingModel, upstreamModel, includeUsage, startTime, len(body))
	} else {
...
func (s *OpenAIGatewayService) handleChatStreamingResponse(
	...
	flushSemanticSSE := func() {
		...
		emitSSE(semanticBufferedSSE.String())
