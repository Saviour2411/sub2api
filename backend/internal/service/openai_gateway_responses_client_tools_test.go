...
func TestOpenAIPassthroughAPIKeyRestoresClientToolsNonStreaming(t *testing.T) {
	...
	result, err := svc.forwardOpenAIPassthrough(context.Background(), c, account, body, body, "gpt-5.4", false, nil, false, false, time.Now())
...
func TestOpenAIPassthroughAPIKeyRestoresClientToolsStreaming(t *testing.T) {
	...
	result, err := svc.forwardOpenAIPassthrough(context.Background(), c, account, body, body, "gpt-5.4", false, nil, true, true, time.Now())
