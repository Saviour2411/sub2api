...
const (
	...
	SettingKeyGatewayAnthropicSamplingParameterFilterEnabled            = "gateway_anthropic_sampling_parameter_filter_enabled"
	SettingKeyGatewayAnthropicSamplingParameterFilterModels             = "gateway_anthropic_sampling_parameter_filter_models"
	SettingKeyGatewayKimiSamplingParameterRetryEnabled                  = "gateway_kimi_sampling_parameter_retry_enabled"
	...
	// SettingKeySubscriptionEnabled 控制订阅界面入口，默认开启。
	// 不影响订阅 API、已有订阅计费及管理 API；与余额充值开关共同决定站点计费模式。
	...
	SettingKeyScheduledTestDefaultPrompt       = "scheduled_test_default_prompt"
