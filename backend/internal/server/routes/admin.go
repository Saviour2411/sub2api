...
func registerContentModerationRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	risk := admin.Group("/risk-control")
	{
		...
		risk.GET("/local-audits", h.Admin.ContentModeration.ListLocalAuditRecords)
		risk.GET("/local-audits/:id", h.Admin.ContentModeration.GetLocalAuditRecord)
		risk.GET("/local-audits/:id/download", h.Admin.ContentModeration.DownloadLocalAuditRecord)
		risk.DELETE("/local-audits/:id", h.Admin.ContentModeration.DeleteLocalAuditRecord)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/api-key", h.Admin.Account.GetAPIKey)
