...
func init() {
	...
	// groupDescClaudeCodeUpstreamMimicry is the schema descriptor for claude_code_upstream_mimicry field.
	groupDescClaudeCodeUpstreamMimicry := groupFields[22].Descriptor()
	// group.DefaultClaudeCodeUpstreamMimicry holds the default value on creation for the claude_code_upstream_mimicry field.
	group.DefaultClaudeCodeUpstreamMimicry = groupDescClaudeCodeUpstreamMimicry.Default.(bool)
	...
	// paymentorderDescBaseAmount is the schema descriptor for base_amount field.
	paymentorderDescBaseAmount := paymentorderFields[5].Descriptor()
	// paymentorder.DefaultBaseAmount holds the default value on creation for the base_amount field.
	paymentorder.DefaultBaseAmount = paymentorderDescBaseAmount.Default.(float64)
	// paymentorderDescBonusAmount is the schema descriptor for bonus_amount field.
	paymentorderDescBonusAmount := paymentorderFields[6].Descriptor()
	...
	paymentorderDescBonusRate := paymentorderFields[7].Descriptor()
