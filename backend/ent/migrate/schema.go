...
var (
	...
	BatchImageJobsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[2], BatchImageJobsColumns[32]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[5], BatchImageJobsColumns[7]},
			},
			{
				Name:    "batchimagejob_idempotency_key",
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[22]},
				Annotation: &entsql.IndexAnnotation{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "claude_code_upstream_mimicry", Type: field.TypeBool, Default: false},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "base_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "bonus_rule_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
