  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        semanticErrorDetection: '2xx Semantic Error Detection',
        semanticErrorDetectionHint: 'When a short 2xx upstream response matches an error semantic rule, return your custom error message; accounts using the upstream-error stop-scheduling strategy are disabled automatically.',
        semanticErrorMaxChars: 'Match Character Limit',
        semanticErrorMaxCharsHint: 'Only responses at or below this character count are checked. Range: 128 to 65536. Default: 4096.',
        semanticErrorRules: 'Semantic Rules',
        semanticErrorRulesHint: 'Rules match by ascending priority; selecting no platform means all platforms.',
        semanticErrorRulesEmpty: 'No rules yet. Semantic matching starts after a rule is added.',
        semanticErrorRuleName: 'Rule name',
        semanticErrorPriority: 'Priority',
        semanticErrorPattern: 'Text or regular expression to match',
        semanticErrorCustomMessage: 'Custom content returned to the client on match',
        semanticErrorPlatformsEmpty: 'None selected = all platforms',
        semanticErrorRegexInvalid: 'The regular expression for semantic error rule "{name}" is invalid.',
        semanticErrorRuleRequired: 'Semantic error rule name, pattern, and custom response content are required.',
      },
      webSearchEmulation: {
