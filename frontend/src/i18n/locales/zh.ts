  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        semanticErrorDetection: '2xx 语义错误识别',
        semanticErrorDetectionHint: '当上游返回 2xx 但短响应内容命中错误语义时，返回自定义错误内容；开启“上游报错后停止调度”的账号会自动停调度。',
        semanticErrorMaxChars: '匹配字符阈值',
        semanticErrorMaxCharsHint: '仅检查不超过该字符数的响应，范围 128 到 65536，默认 4096。',
        semanticErrorRules: '语义匹配规则',
        semanticErrorRulesHint: '按优先级从小到大匹配；平台全不选表示适用于所有平台。',
        semanticErrorRulesEmpty: '暂无规则，添加后才会进行语义匹配。',
        semanticErrorRuleName: '规则名称',
        semanticErrorPriority: '优先级',
        semanticErrorPattern: '匹配内容或正则表达式',
        semanticErrorCustomMessage: '命中后返回给客户端的自定义内容',
        semanticErrorPlatformsEmpty: '全不选 = 全平台',
        semanticErrorRegexInvalid: '语义错误规则「{name}」的正则表达式无效。',
        semanticErrorRuleRequired: '语义错误规则的名称、匹配内容和自定义返回内容不能为空。',
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',
