  ...
  admin: {
    ...
    customFeatures: {
      ...
      upstream: {
        ...
        newAPIAccessTokenHint: 'Enter the personal access token generated in the New API profile. This mode does not use an account password, cookie, refresh token, or imported session User-Agent.',
        ...
        newAPITokenRequired: 'Enter a New API personal access token',
        cancel: 'Cancel',
        save: 'Save',
      ...
      gateway: {
        ...
        kimiCompatibility: {
          ...
          description: 'Five independent switches, disabled by default, for Chat Completions upstreams in Kimi groups, including converted Messages/Responses requests. Retry explicit parameter rejections only before committing the client response, once per rule and at most five additional attempts per request.',
          sampling: {
          ...
          thinkingType: {
            title: 'Thinking mode type compatibility',
        ...
        firstTokenTimeout: {
          ...
          accountWideWarning: 'The consecutive timeout threshold stops scheduling this account in every linked group. Recovery requires a timely first token and a successful probe.',
        ...
        validation: {
          ...
          firstTokenGroups: 'Select at least one group',
