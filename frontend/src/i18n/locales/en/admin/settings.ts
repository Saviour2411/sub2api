export default {
    settings: {
      ...
      defaults: {
        ...
        scheduledTestDefaultPrompt: 'Default Account Test Prompt',
        scheduledTestDefaultPromptPlaceholder: 'hi',
        scheduledTestDefaultPromptHint: 'Used when a manual or scheduled account test does not specify its own prompt. Empty values are saved as hi.',
