export default {
    scheduledTests: {
      ...
      model: 'Model',
      prompt: 'Test Prompt',
      promptPlaceholder: 'Leave empty to use the global default prompt hi',
      promptHelp: 'Text sent to the upstream model when the scheduled test runs. Empty values use the account test default prompt from system settings.',
