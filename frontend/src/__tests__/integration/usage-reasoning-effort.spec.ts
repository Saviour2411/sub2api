...
function clickReasoningEffortToggle(): void {
  const toggles = document.body.querySelectorAll<HTMLElement>('[data-testid="usage-column-toggle-reasoning_effort"]')
  const reasoningToggle = toggles.item(toggles.length - 1)
