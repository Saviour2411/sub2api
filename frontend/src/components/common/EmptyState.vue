<template>
  <div class="empty-state">
    <!-- Icon -->
    <div
      class="mb-5 flex h-20 w-20 items-center justify-center rounded-lg border border-primary-200/70 bg-primary-50/70 shadow-inner dark:border-primary-400/20 dark:bg-primary-500/10"
    >
      <slot name="icon">
