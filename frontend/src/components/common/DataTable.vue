<template>
        ...
        :class="[
          compact ? 'p-3' : 'p-4',
          {
            ...
            'border-primary-300 bg-primary-50/40 dark:border-primary-700 dark:bg-primary-900/10':
              selectable && isRowSelected(row, index)
          }
        ]"
      ...
      >
        <div :class="compact ? 'space-y-2' : 'space-y-3'">
          ...
          <div
            ...
            class="flex min-w-0 items-start justify-between"
  ...
  <div
    ...
    ref="tableWrapperRef"
    class="table-wrapper"
    :data-virtualized="String(shouldVirtualize)"
      ...
      <tbody class="table-body divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
        ...
        <tr v-if="loading" v-for="i in 5" :key="i">
          ...
          <td
            ...
            :key="column.key"
            :class="['whitespace-nowrap', compact ? 'py-2.5' : 'py-4', getAdaptivePaddingClass()]"
          >
            ...
            <tr
              ...
              :class="{
                ...
                'bg-primary-50/40 dark:bg-primary-900/10':
                  selectable && isRowSelected(item.row, item.index)
              }"
