...
const IMAGE_KEYWORDS = ["seedream", "gpt-image", "image", "dall-e", "dalle", "imagen", "nano-banana", "nano_banana", "flux", "sdxl", "stable-diffusion", "midjourney"];
            ...
            merge: (persisted, current) => {
                ...
                return {
                    ...
                    config: {
                        ...
                        canvasImageCount: persistedConfig.canvasImageCount === "3" ? "1" : config.canvasImageCount || "1",
                    },
                };
            },
        },
