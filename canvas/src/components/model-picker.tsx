...
function resolveModelIcon(model: string) {
    ...
    if (name.includes("claude") || name.includes("anthropic")) return "/canvas-app/icons/claude.svg";
    if (name.includes("gemini") || name.includes("google")) return "/canvas-app/icons/gemini.svg";
    if (name.includes("gpt") || name.includes("openai")) return "/canvas-app/icons/openai.svg";
    if (name.includes("grok")) return "/canvas-app/icons/grok.svg";
    if (name.includes("deepseek")) return "/canvas-app/icons/deepseek.svg";
    if (name.includes("glm")) return "/canvas-app/icons/glm.svg";
    return "";
}
